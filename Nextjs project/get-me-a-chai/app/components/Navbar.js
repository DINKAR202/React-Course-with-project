...
const Navbar = () => {
  ...
  const [showDropdown, setShowDropdown] = useState(false); // Changed from true to false
      ...
      <div>
        {session && (
          <>
            ...
            <div
              id="dropdown"
              className={`z-10 ${showDropdown ? "" : "hidden"} bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
            >
