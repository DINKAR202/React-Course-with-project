        ...
        <div className="gradient-cards">
          <div className="card">
            <div className="container-card bg-green-box">
              ...
              <p className="card-title">React.js Developer</p>
              <p className="card-description">
                I specialize in front-end development using React.js, where I
                create dynamic user interfaces integrated with cutting-edge
                libraries such as Material-UI and Tailwind CSS. I leverage the
                power of React Hooks to build efficient and responsive
